    ...
    public ArrayList<HashMap<String, String>> getContractValues(Elements data) {
        ...
        for (Element player : data) {
            ...
            if (!playerName.equals("Player") && !playerName.isEmpty()) {
                ...
                dataMap.put("2019-2020", y1Num);
                dataMap.put("2020-2021", y2Num);
                dataMap.put("2021-2022", y3Num);
                dataMap.put("2022-2023", y4Num);
                dataMap.put("2023-2024", y5Num);
                dataMap.put("2024-2025", y6Num);
                dataMap.put("guaranteed", gtdNum);
